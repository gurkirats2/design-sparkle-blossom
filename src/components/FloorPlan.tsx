...
const FloorPlan: React.FC = () => {
  return (
    <div className="w-full max-w-7xl mx-auto p-4 overflow-auto">
      <div className="grid grid-cols-12 gap-0.5 min-w-[1000px]">
        {/* Top Row */}
        ...
        <div className="col-span-1"><FloorCell roomNumber="269" sizes={["20.5m²", "7.5m²"]} /></div>
        ...
        <div className="col-span-3"><SpecialCell text="LIFT" /></div>
        ...
        <div className="col-span-1"></div>
        <div className="col-span-1"><FloorCell roomNumber="286" sizes={["3m²"]} /></div>
        ...
        <div className="col-span-1"><FloorCell roomNumber="305" sizes={["4.75m²", "13m²"]} /></div>
        ...
        <div className="col-span-12 grid grid-cols-24 gap-0.5">
          ...
          <div className="col-span-1"><FloorCell roomNumber="318-2" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="315" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="315-1" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="315-2" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="312" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="312-1" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="312-2" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="310" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="310-1" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="310-2" sizes={["2m²", "5m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="308" sizes={["3m²", "8m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="308-1" sizes={["3m²", "8m³"]} /></div>
          <div className="col-span-1"><FloorCell roomNumber="306" sizes={["3m²", "8m³"]} /></div>
        ...
        <div className="col-span-1 grid grid-rows-10 gap-0.5">
          <div><FloorCell roomNumber="287" sizes={["3m²"]} /></div>
          <div><FloorCell roomNumber="288" sizes={["3m²"]} /></div>
          <div><FloorCell roomNumber="289" sizes={["3m²"]} /></div>
          <div><FloorCell roomNumber="290" sizes={["3m²"]} /></div>
          <div><FloorCell roomNumber="291" sizes={["5m²"]} /></div>
          <div><FloorCell roomNumber="292" sizes={["3m²"]} /></div>
          <div><FloorCell roomNumber="293" sizes={["3m²"]} /></div>
